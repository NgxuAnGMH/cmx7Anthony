...
一般情况下，空间复杂度的统计范围是“<u>暂存空间</u>”加上“<u>输出空间</u>”。
...
在分析一段程序的空间复杂度时，我们通常统计==暂存数据==、==栈帧空间==和==输出数据==三部分，如下图所示。

![算法使用的相关空间](./HelloAlgo.assets/space_types.png)
...
![常见的空间复杂度类型](./HelloAlgo.assets/space_complexity_common_types.png)
...
![递归函数产生的线性阶空间复杂度](./HelloAlgo.assets/space_complexity_recursive_linear.png)
...
![递归函数产生的平方阶空间复杂度](./HelloAlgo.assets/space_complexity_recursive_quadratic.png)
...
![满二叉树产生的指数阶空间复杂度](./HelloAlgo.assets/space_complexity_exponential.png)
