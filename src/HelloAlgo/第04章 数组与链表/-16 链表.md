...
![链表定义与存储方式](./HelloAlgo.assets/linkedlist_definition.png)
...
![链表插入节点示例](./HelloAlgo.assets/linkedlist_insert_node.png)
...
![链表删除节点](./HelloAlgo.assets/linkedlist_remove_node.png)
...
![常见链表种类](./HelloAlgo.assets/linkedlist_common_types.png)
